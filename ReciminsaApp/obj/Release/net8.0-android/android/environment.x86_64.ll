...
@dso_cache = dso_local local_unnamed_addr global [616 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 856003493669348447, ; hash 0xbe122a466a7a45f, from name: aot-ReciminsaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 26
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.100_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2263251708585017127, ; hash 0x1f68af700f817f27, from name: libaot-ReciminsaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 71
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.99_name, ; name: libaot-System.dll.so
		ptr null; void* handle (0x0)
	}, ; 99
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9874521978563859181, ; hash 0x8909596c0b1612ed, from name: ReciminsaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 324
	...
	%struct.DSOCacheEntry {
		i64 10177899987590566052, ; hash 0x8d3f2a1d27c9d0a4, from name: libaot-ReciminsaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 333
	...
	%struct.DSOCacheEntry {
		i64 12942881500640190141, ; hash 0xb39e5a2687a21ebd, from name: ReciminsaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 441
	...
	%struct.DSOCacheEntry {
		i64 14379488560388733315, ; hash 0xc78e34a8edc37983, from name: aot-ReciminsaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 497
...
@.env.3 = private unnamed_addr constant [37 x i8] c"34677a93-2ffc-4528-9db4-fb19c168e0c3\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.reciminsaapp\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [27 x i8] c"libaot-ReciminsaApp.dll.so\00", align 16
...
@.DSOCacheEntry.99_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 16
@.DSOCacheEntry.100_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
