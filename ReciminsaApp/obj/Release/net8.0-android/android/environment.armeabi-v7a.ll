...
@dso_cache = dso_local local_unnamed_addr global [616 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2458516378, ; hash 0x9289fb9a, from name: aot-ReciminsaApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2598472537, ; hash 0x9ae18b59, from name: ReciminsaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 368
	...
	%struct.DSOCacheEntry {
		i64 2672760160, ; hash 0x9f4f1560, from name: aot-ReciminsaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 380
	...
	%struct.DSOCacheEntry {
		i64 3079666166, ; hash 0xb78ff9f6, from name: ReciminsaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 448
	...
	%struct.DSOCacheEntry {
		i64 3812232106, ; hash 0xe33a0baa, from name: libaot-ReciminsaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 549
	...
	%struct.DSOCacheEntry {
		i64 4093883867, ; hash 0xf403b5db, from name: libaot-ReciminsaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ReciminsaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 586
